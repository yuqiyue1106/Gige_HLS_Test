...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_design_1_clk_wiz_2_0_clk_wiz is
  ...
  signal clk_out100_design_1_clk_wiz_2_0 : STD_LOGIC;
  signal clk_out156_design_1_clk_wiz_2_0 : STD_LOGIC;
...
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out100_design_1_clk_wiz_2_0,
      O => clk_out100
    );
clkout2_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out156_design_1_clk_wiz_2_0,
      O => clk_out156
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKOUT0 => clk_out100_design_1_clk_wiz_2_0,
      CLKOUT0B => NLW_mmcme4_adv_inst_CLKOUT0B_UNCONNECTED,
      CLKOUT1 => clk_out156_design_1_clk_wiz_2_0,
