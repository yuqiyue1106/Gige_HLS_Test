...
#-----------------------------------------------------------
#set_property DELAY_VALUE  900   [get_cells -hier -filter {name =~ *design_1_gmii_to_rgmii_0_0_core/*delay_rgmii_rx_ctl          }]
#set_property DELAY_VALUE  900   [get_cells -hier -filter {name =~ *design_1_gmii_to_rgmii_0_0_core/*delay_rgmii_rxd*            }]
